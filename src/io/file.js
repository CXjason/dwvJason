...
/**
 * Load a list of files.
 * @method load  传入的是ArrayBuffer
 * @param {Array} aBuffer arrayBuffer的数组
 */
dwv.io.File.prototype.loadArrayBuffer = function (aBuffer) 
{
    // closure to self for handlers
    var self = this;
    // set the number of data to load
    this.setNToLoad( aBuffer.length );
    ...
    {
        onLoad( dwv.image.getDataFromDicomBuffer(aBuffer[i]) );
